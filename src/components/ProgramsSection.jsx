                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {programs.map((program, index) => (
                        <ScrollReveal
                            ...
                            variant="slideUp"
                            delay={index * 0.1}
                            className={`group bg-white/80 backdrop-blur-xl border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full`}
                        >
                            {/* Course Image */}
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                ...
                                <p className="text-gray-600 mb-4 leading-normal text-center text-sm flex-grow">
                                    {program.description}
                                </p>
                                ...
                                <Link
                                    ...
                                    className="block w-2/3 mx-auto bg-accent hover:bg-accent-dark text-white py-2 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-accent/30 hover:-translate-y-1 text-center text-xs mt-auto"
                                >
                                    View Details
                                </Link>
                            </div>
